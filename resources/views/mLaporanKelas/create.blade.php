                            ...
                            <div class="intro-y box lg:mt-5">
                                <div class="flex items-center p-5 border-b border-gray-200 dark:border-dark-5">
                                    <h2 class="font-medium text-base mr-auto">
                                        Form Generate Laporan Sarpras Kelas
                                    </h2>
                                </div>
                                <div class="p-5">
                                    <form action="{{ route('Pass.store') }}" method="POST" enctype="multipart/form-data" target="_blank">
                                        @csrf
                                        <div class="grid grid-cols-12 gap-x-5">
                                            <div class="col-span-12 xxl:col-span-6">
                                                <div>
                                                    <label for="update-profile-form-3" class="form-label">Ruang kelas</label>
                                                    <select id="ruang-kelas" name="kelas" id="update-profile-form-3" data-search="true" class="tail-select w-full">
...
<script type="text/javascript">
    $(function () {
        $('#ruang-kelas').change(function () {
            ...
            $.ajax({
                url: "{{ route('getExistedLaporan.data', '') }}/" + selectedValue,
                method: 'GET',
