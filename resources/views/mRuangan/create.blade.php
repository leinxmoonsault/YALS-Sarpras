                                ...
                                <div class="p-5">
                                    <div class="flex flex-col-reverse xl:flex-row flex-col">
                                        <div class="flex-1 mt-6 xl:mt-0">
                                            <form action="{{ route('Go.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                            <div class="grid grid-cols-12 gap-x-5">
                                                <div class="col-span-12 xxl:col-span-6">
                                                    <div>
                                                        <label for="update-profile-form-1" class="form-label">Nama Ruangan</label>
                                                        <input name="nama_ruangan" id="update-profile-form-1" type="text" class="form-control" placeholder="Input Kelas Contoh : Ruang Guru, Masjid">
                                                    </div>
                                                </div>
                                                <div class="col-span-12 xxl:col-span-6">
